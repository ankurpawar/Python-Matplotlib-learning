...
myAnimation = animation.FuncAnimation(fig, animate, get_pos,
                                      interval=10, blit=True, repeat=False, save_count=1000)

plt.show()
myAnimation.save('WheelsOnWheelsOnWheels.gif', writer=animation.PillowWriter(fps=20))
